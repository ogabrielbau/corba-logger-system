...
#ifndef _TAO_IDL_LOGGERS_VEIMAB_CPP_
#define _TAO_IDL_LOGGERS_VEIMAB_CPP_
...
class TAO_LoggerModule_Logger_Perfect_Hash_OpTable
...
/* Command-line: ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_LoggerModule_Logger_Perfect_Hash_OpTable -N lookup */

unsigned int
TAO_LoggerModule_Logger_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
...
TAO_LoggerModule_Logger_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 8,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      {"",0,0},{"",0,0},{"",0,0},
      {"log", std::addressof(POA_LoggerModule::Logger::log_skel), nullptr},
      ...
      {"_get_verbose", std::addressof(POA_LoggerModule::Logger::_get_verbose_skel), 0},
      {"_set_verbose", std::addressof(POA_LoggerModule::Logger::_set_verbose_skel), nullptr},
...
static TAO_LoggerModule_Logger_Perfect_Hash_OpTable tao_LoggerModule_Logger_optable;
...
POA_LoggerModule::Logger::Logger ()
  : TAO_ServantBase ()
{
  this->optable_ = std::addressof(tao_LoggerModule_Logger_optable);
}

POA_LoggerModule::Logger::Logger (const Logger& rhs)
...
namespace POA_LoggerModule
{
  ...
  public:
    inline log_Logger (
      POA_LoggerModule::Logger * servant,
    ...
    {
      TAO::SArg_Traits< ::LoggerModule::Severity>::in_arg_type arg_1 =
        TAO::Portable_Server::get_in_arg< ::LoggerModule::Severity> (
  ...
  private:
    POA_LoggerModule::Logger * const servant_;
...
void POA_LoggerModule::Logger::log_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{TAO::SArg_Traits< void>::ret_val retval;
  TAO::SArg_Traits< ::LoggerModule::Severity>::in_arg_val _tao_severidade;
  ...
  POA_LoggerModule::Logger * const impl =
    dynamic_cast<POA_LoggerModule::Logger *> (servant);
...
void POA_LoggerModule::Logger::_get_verbose_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
...
void POA_LoggerModule::Logger::_set_verbose_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{TAO::SArg_Traits< void>::ret_val retval;
...
::CORBA::Boolean POA_LoggerModule::Logger::_is_a (const char* value)
{
  return
    (
...
const char* POA_LoggerModule::Logger::_interface_repository_id () const
{
...
void POA_LoggerModule::Logger::_dispatch (
...
POA_LoggerModule::Logger::_this ()
{
  ...
  if (obj.ptr ())
    {
      (void) stub.release ();
      return TAO::Narrow_Utils<::LoggerModule::Logger>::unchecked_narrow (obj.in ());
    }
  return {};
}
