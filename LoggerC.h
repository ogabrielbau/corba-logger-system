...
#ifndef _TAO_IDL_LOGGERC_2LSUTN_H_
#define _TAO_IDL_LOGGERC_2LSUTN_H_
...
// TAO_IDL - Generated from
// /opt/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_module/module_ch.cpp:34
...
#if !defined (_LOGGERMODULE_LOGGER__VAR_OUT_CH_)
#define _LOGGERMODULE_LOGGER__VAR_OUT_CH_
...
// TAO_IDL - Generated from
// /opt/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_module/module_ch.cpp:62
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::LoggerModule::Severity>
    : public
        Basic_Arg_Traits_T<
...
#if !defined (_LOGGERMODULE_LOGGER__ARG_TRAITS_)
#define _LOGGERMODULE_LOGGER__ARG_TRAITS_

  template<>
  class  Arg_Traits< ::LoggerModule::Logger>
    : public Object_Arg_Traits_T<
        ::LoggerModule::Logger_ptr,
        ::LoggerModule::Logger_var,
        ::LoggerModule::Logger_out,
        TAO::Objref_Traits<LoggerModule::Logger>,
        TAO::Any_Insert_Policy_Stream>
  {
  };
...
#if !defined (_LOGGERMODULE_LOGGER__TRAITS_)
#define _LOGGERMODULE_LOGGER__TRAITS_

  template<>
  struct  Objref_Traits< ::LoggerModule::Logger>
  {
    static ::LoggerModule::Logger_ptr duplicate (::LoggerModule::Logger_ptr p);
    static void release (::LoggerModule::Logger_ptr p);
    static ::LoggerModule::Logger_ptr nil ();
    static ::CORBA::Boolean marshal (const ::LoggerModule::Logger_ptr p,TAO_OutputCDR & cdr);
  };
...
namespace CORBA {
 ...
 void operator<<= (::CORBA::Any &, LoggerModule::Severity);
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, LoggerModule::Severity &);
}
TAO_END_VERSIONED_NAMESPACE_DECL
...
namespace CORBA {
 ...
 void operator<<= (::CORBA::Any &, LoggerModule::Logger_ptr); // copying
 void operator<<= (::CORBA::Any &, LoggerModule::Logger_ptr *); // non-copying
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, LoggerModule::Logger_ptr &);
}
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const LoggerModule::Logger_ptr );
 ::CORBA::Boolean operator>> (TAO_InputCDR &, LoggerModule::Logger_ptr &);
